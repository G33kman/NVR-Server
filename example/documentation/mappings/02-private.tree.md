...
<p align="center">
    <picture>
        <source media="(prefers-color-scheme: dark)" srcset="/documentation/assets/images/hero/private-hero-image.jpg">
        <img src="/documentation/assets/images/hero/private-hero-image.jpg" width="65%">
    </picture>
</p>

> An image of a folder with a lock in front of it and keys and some random text on tags around the folder.

---

This file lists the different sections inside the private folder with definitions and examples as needed.
